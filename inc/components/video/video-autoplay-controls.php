...
if ( ! function_exists( 'epaton_render_video_autoplay_controls' ) ) {
	 ...
	 */
	function epaton_render_video_autoplay_controls( $args = [] ) {
		$defaults = [
			'class' => '',
			'echo'  => true,
		];
		...
		$html .= '<button class="video-control-btn video-play-pause-btn" aria-label="' . esc_attr__( 'Play/Pause', 'epaton' ) . '">';
		$html .= epaton_render_video_icon( 'play' );
		$html .= epaton_render_video_icon( 'pause' );
		$html .= '</button>';

		// Mute/Unmute Button - Both icons inside
		$html .= '<button class="video-control-btn video-mute-btn" aria-label="' . esc_attr__( 'Mute/Unmute', 'epaton' ) . '">';
		$html .= epaton_render_video_icon( 'unmute' );
		$html .= epaton_render_video_icon( 'mute' );
		$html .= '</button>';
...
if ( ! function_exists( 'epaton_render_video_icon' ) ) {
	/**
	 ...
	 */
	function epaton_render_video_icon( $icon ) {
		$icons = [
